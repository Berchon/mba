# Neste exemplo, usamos a cadeia de sumarização do LangChain para resumir um texto longo.
# Note que usamos o TextSplitter para dividir o texto em partes menores antes de resumir.
# Entretanto, se o texto for muito grande para o modelo, a cadeia "map_reduce" é mais adequada,
# pois ela resume cada parte individualmente antes de combinar os resumos em um resumo final.
