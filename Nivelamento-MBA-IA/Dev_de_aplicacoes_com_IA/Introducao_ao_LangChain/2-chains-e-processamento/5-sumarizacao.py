# Neste exemplo, mostramos como usar a cadeia de sumarização do LangChain para resumir um texto longo.
# Note que usamos o TextSplitter para dividir o texto em partes menores antes de resumir.
# Isso é útil para lidar com limitações de tamanho de entrada do modelo, mas nesse caso,
# não precisaríamos dividir o texto. Estamos fazendo isso apenas para demonstrar o uso do 
# TextSplitter.
...
chain_sumarize = load_summarize_chain(llm, chain_type="stuff", verbose=True)
